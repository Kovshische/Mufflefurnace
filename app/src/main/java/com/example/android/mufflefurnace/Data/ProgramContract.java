...
public final class ProgramContract {
    ...
    public static final String PACTH_PROGRAMS = "programs";
    public static final String PATCH_POINTS = "points";
    public static final String PATCH_A_PROGRAMS = "a_programs";
    public static final String PATCH_A_POINTS = "a_points";

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static abstract class ProgramEntry implements BaseColumns {

        public static final Uri CONTENT_URI_PROGRAMS = Uri.withAppendedPath(BASE_CONTENT_URI, PACTH_PROGRAMS);
        public static final Uri CONTENT_URI_POINTS = Uri.withAppendedPath(BASE_CONTENT_URI, PATCH_POINTS);
        public static final Uri CONTENT_URI_A_PROGRAMS = Uri.withAppendedPath(BASE_CONTENT_URI,PATCH_A_PROGRAMS);
        public static final Uri CONTENT_URI_A_POINTS = Uri.withAppendedPath(BASE_CONTENT_URI,PATCH_A_POINTS);
...
//        public static final String COLUMN_A_PROGRAM_NAME = "a_program_name";
        ...
        public static final String CONTENT_LIST_PROGRAMS_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PACTH_PROGRAMS;

        /**
         * The MIME type of the {@link #CONTENT_URI_POINTS} for a list of programs.
         */
        public static final String CONTENT_LIST_POINTS_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PATCH_POINTS;
        ...
        public static final String CONTENT_LIST_A_PROGRAMS_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" +PATCH_A_PROGRAMS;
        ...
        public static final String CONTENT_LIST_A_POINTS_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" +PATCH_A_POINTS;
        ...
        public static final  String CONTENT_ITEM_PROGRAM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PACTH_PROGRAMS;

        /**
         * The MIME type of the {@link #CONTENT_URI_PROGRAMS} for a single pet.
         */
        public static final  String CONTENT_ITEM_POINT_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PATCH_POINTS;
        ...
        public static final  String CONTENT_ITEM_A_PROGRAM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PATCH_A_PROGRAMS;

        /**
         * The MIME type of the {@link #CONTENT_URI_A_POINTS} for a single pet.
         */
        public static final  String CONTENT_ITEM_A_POINT_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PATCH_A_POINTS;
